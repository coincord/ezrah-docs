...
```ts
{
  ...
  attachments: [
    await DidService.generatePresentationExchangeFormat(verificationModel),
  ],
}
```
...
```ts
{
  ...
  body: {
    presentation_submission: {
      // Standard format aligned with Presentation Exchange v2
    },
  },
  attachments: [
    {
...
* [Presentation Exchange Format](https://identity.foundation/presentation-exchange/)
<!-- * [Ezrah DID Registry](https://docs.ezrah.co/docs/did-registry) -->
<!-- * [Building Wallet Agents](https://docs.ezrah.co/docs/wallet-integration) -->

---

Let me know if you’d like this formatted as markdown, Docusaurus-compatible, or hosted on a live site — I can generate or export it accordingly.
