...
```
These details who and outline how to communicate with a particular did within the protocol, as well as encryption standards and public communication keys, a did might have reserved several service endpoints and encryption keys for multiple devices ownership and communication flow 
